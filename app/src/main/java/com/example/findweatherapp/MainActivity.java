...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, GetDataFromInternet.AsyncResponse {
    ...
    public void onClick(View v) {
          //  URL url = new URL("https://api.openweathermap.org/data/2.5/weather/?q=Azov&appid=70f0b1912f46839389688cf5e8470199");
    ...
    private URL buildUrl (String city) {
        ...
        String appid_value="70f0b1912f46839389688cf5e8470199";
